    ...
    >
      ...
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          <div className="hidden md:flex items-center gap-1 bg-white rounded-full px-4 py-1 shadow-md">
            <button className="px-3 py-1 text-[14px] font-medium text-black transition-colors hover:text-gray-500">
              Features
            </button>
            <button className="px-3 py-1 text-[14px] font-medium text-black transition-colors hover:text-gray-500">
              Pricing
        ...
        <button className="relative flex items-center rounded-full bg-[#047FB3] px-3 py-[6px] text-[14px] font-semibold text-black transition-colors hover:scale-105 max-md:px-2 max-md:py-1 max-md:text-[12px] text-white" style={{ mixBlendMode: 'difference' }}>
          Get Started
