  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={() => scrollTo('auth')} className="relative flex items-center rounded-full bg-[#047FB3] px-3 py-[6px] text-[14px] font-semibold text-black transition-colors hover:scale-105 max-md:px-2 max-md:py-1 max-md:text-[12px] text-white" style={{ mixBlendMode: 'difference' }}>
          Get Started
